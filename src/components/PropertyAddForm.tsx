...
import { PropertyForm } from "@/lib/types";
  ...
  if(!session || !session?.user){
    return (
      <div className="text-center">
        ...
        <button onClick={()=>signIn()} className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline">Sign in</button>
      </div>
    )
  }
